...
public final class TestInfo {
    ...
    public static String getClassName(ITestResult result) {
        Class<?> dClass = result.getMethod().getConstructorOrMethod().getDeclaringClass();
    ...
    public static String getContainingPackageName(ITestResult result) {
        Package dPackage = result.getMethod().getConstructorOrMethod().getDeclaringClass().getPackage();
